...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with the provided invalid credentials and submit the form (click Login). After submit, verify that an error message about invalid credentials appears.
        frame = context.pages[-1]
        # Input text
