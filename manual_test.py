    ...
    try:
        ...
        browser = await pw.chromium.launch(
            ...
            args=[
                ...
                "--disable-=-shm-usage",        # Avoid using /dev/shm which can cause issues in containers
        ...
        # -> Navigate to https://ecommerce-platform-ezhyg6ohc-sherrys-projects-d8ad7a21.vercel.app
        await page.goto("https://ecommerce-platform-ezhyg6ohc-sherrys-projects-d8ad7a21.vercel.app")
        
        # -> Navigate to /login (explicit navigate to path as required)
        await page.goto("https://ecommerce-platform-ezhyg6ohc-sherrys-projects-d8ad7a21.vercel.app/login")
